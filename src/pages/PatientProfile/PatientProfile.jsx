...
{/* Right Side - Google Calendar, Health Goals, and Recent Medications History */}
<Box flex="1" bg="white" borderRadius="xl" shadow="xl" p={8}>
  {/* Google Calendar Embed */}
  <Heading fontSize="xl" color="#252B42" mb={4} textAlign="center">Upcoming Appointments</Heading>
